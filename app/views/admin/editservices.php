    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand brand-logo" href="index.html"><img src="public/adminimages/logo.svg" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="home.html"><img src="public/admin/images/logo-mini.svg" alt="logo"/></a>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post">
                      ...
                      <input id="sertitle" name="sertitle" type="text" class="form-control" required="true" value="">
                    </div>
                    <div class="form-group">
