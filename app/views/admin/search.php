          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                ...
                <h4 class="card-title" style="padding-left: 20px; padding-top: 20px;">Result against keyword</h4>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <a href="/webprojfinal/editscdetils" class="btn btn-success btn-sm btn-icon-text mr-3">Edit <i class="typcn typcn-edit btn-icon-append"></i> </a> 
                                            <a href="/webprojfinal/managescdetails" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-sm btn-icon-text">Delete <i class="typcn typcn-delete-outline btn-icon-append"></i></a>
                          </div>
                        </td>
                      </tr>
  <tr>
